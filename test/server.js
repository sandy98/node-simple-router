...
(function() {
  var Router, argv, base_context, clean_up, createProxy, defer, e, e2, fakehandler, fs, func, get_wiki, http, https, msgs, path, router, scgi_child, server, site_router, socks, spawn, wamp, wsserver, _extend, _ref;
