...
(function() {
  var Router, argv, base_context, clean_up, e, e2, fakehandler, fs, func, get_wiki, http, https, router, scgi_child, server, site_router, spawn, _extend;
    ...
    return fs.readFile("" + __dirname + "/templates/session.html", {
      ...
      return router.getSession(request, function(sess) {
        ...
        obj.handlers = (function() {
          ...
          _ref = router.avail_nsr_session_handlers;
          _results = [];
