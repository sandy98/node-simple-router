...
(function() {
  var Router, argv, base_context, clean_up, e, e2, fakehandler, fs, func, get_wiki, http, https, msgs, path, router, scgi_child, server, site_router, socks, spawn, wsserver, _extend, _ref;
  ...
  _ref = require("" + __dirname + path.sep + "chatws"), wsserver = _ref.wsserver, socks = _ref.socks, msgs = _ref.msgs;
    ...
    return fs.readFile("" + __dirname + "/templates/session.html", {
      ...
      return router.getSession(request, function(sess) {
        ...
        obj.handlers = (function() {
          ...
          _ref1 = router.avail_nsr_session_handlers;
          _results = [];
  ...
  server.on('listening', function() {
    ...
    addr = server.address();
    return router.log(("NSR v" + router.version + " serving web content at " + (typeof addr === 'string' ? addr : addr.address + ':' + addr.port) + " - PID: ") + process.pid + " from directory: " + process.cwd());
  });
