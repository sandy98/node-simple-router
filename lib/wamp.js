...
(function() {
  var MAX_ID, MESSAGE_TYPES, TRANSPORT_TYPES, WampClient, WampPeer, WampRouter, createWampRouter, events, genId, isValidURI, net, randomNum, test, util, ws,
  ...
  WampPeer = (function(_super) {
    ...
    WampPeer.prototype.cleanUp = function() {
      var e, index, invocation, invocations, key, proc, registered, session, sessions, subscription, subscriptions, topic, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _results;
    ...
    WampPeer.prototype.processMessage = function(message) {
      ...
      switch (code) {
        ...
        case MESSAGE_TYPES.PUBLISH:
          ...
          if (topic) {
            for (_i = 0, _len = topic.length; _i < _len; _i++) {
              ...
              _ref2 = this.parent.realms[this.realm].sessions;
        ...
        case MESSAGE_TYPES.UNSUBSCRIBE:
          ...
          _ref5 = this.parent.realms[this.realm].subscriptions;
          for (key in _ref5) {
            topic = _ref5[key];
            for (index = _k = 0, _len2 = topic.length; _k < _len2; index = ++_k) {
              subscription = topic[index];
        ...
        case MESSAGE_TYPES.CALL:
          ...
          _ref7 = this.parent.realms[this.realm].registered_procedures;
          for (_l = 0, _len3 = _ref7.length; _l < _len3; _l++) {
            ...
            if (proc.ProcedureUri === ProcedureUri) {
              ...
              _ref8 = this.parent.realms[this.realm].sessions;
        ...
        case MESSAGE_TYPES.REGISTER:
          ...
          _ref10 = this.parent.realms[this.realm].registered_procedures;
        ...
        case MESSAGE_TYPES.UNREGISTER:
          ...
          _ref11 = arr.slice(1), RequestId = _ref11[0], RegistrationId = _ref11[1];
          _ref12 = this.parent.realms[this.realm].registered_procedures;
          for (index = _o = 0, _len6 = _ref12.length; _o < _len6; index = ++_o) {
            procedure = _ref12[index];
        ...
        case MESSAGE_TYPES.YIELD:
          _ref13 = arr.slice(1), RequestId = _ref13[0], OptionsDict = _ref13[1], ArgumentsList = _ref13[2], ArgumentsKwDict = _ref13[3];
          _ref14 = this.parent.realms[this.realm].invocations;
          for (_p = 0, _len7 = _ref14.length; _p < _len7; _p++) {
            invocation = _ref14[_p];
            if (invocation.requestId === RequestId) {
              caller_sessionId = invocation.sessionId;
              _ref15 = this.parent.realms[this.realm].sessions;
              for (_q = 0, _len8 = _ref15.length; _q < _len8; _q++) {
                session = _ref15[_q];
  ...
  WampClient = (function(_super) {
    ...
    function WampClient() {
      return WampClient.__super__.constructor.apply(this, arguments);
    }
