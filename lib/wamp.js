...
(function() {
    ...
    WampPeer.prototype.processMessage = function(message) {
      ...
      switch (code) {
        ...
        case MESSAGE_TYPES.WELCOME:
          ...
          this.id = sid;
          this.routerRoles = details.roles;
          return this.realm = this.parent.realm;
  ...
  WampClient = (function(_super) {
    ...
    function WampClient(url, realm, options) {
      this._options = options || {};
      this.realm = realm;
      ...
      this.websocket = new ws.WebSocketClientConnection(url, this._options);
