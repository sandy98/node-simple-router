    ...
    WampPeer.prototype.processMessage = function(message) {
      ...
      switch (code) {
        ...
        case MESSAGE_TYPES.GOODBYE:
          ...
          sessions = (_ref1 = this.parent.realms) != null ? _ref1[this.realm].sessions : void 0;
          if (sessions) {
            for (index = _i = 0, _len = sessions.length; _i < _len; index = ++_i) {
        ...
        case MESSAGE_TYPES.PUBLISH:
          ...
          if (topic) {
            for (_j = 0, _len1 = topic.length; _j < _len1; _j++) {
              suscription = topic[_j];
        ...
        case MESSAGE_TYPES.UNSUBSCRIBE:
          ...
          for (key in _ref6) {
            topic = _ref6[key];
            for (index = _l = 0, _len3 = topic.length; _l < _len3; index = ++_l) {
        ...
        case MESSAGE_TYPES.CALL:
          console.log("Received Call Message from session " + this.id + " with request Id = " + arr[1]);
        ...
        case MESSAGE_TYPES.YIELD:
          console.log("Received Yield Message from session " + this.id);
          _ref11 = arr.slice(1), RequestId = _ref11[0], OptionsDict = _ref11[1], ArgumentsList = _ref11[2], ArgumentsKwDict = _ref11[3];
          console.log("Yield message data\nRequestId: " + RequestId);
          console.log("OptionsDict: %j", OptionsDict);
          console.log("ArgumentsList: " + ArgumentsList);
          console.log("ArgumentsKwDict: " + ArgumentsKwDict);
          _ref12 = this.parent.realms[this.realm].invocations;
          for (_o = 0, _len6 = _ref12.length; _o < _len6; _o++) {
            invocation = _ref12[_o];
            if (invocation.requestId === RequestId) {
              caller_sessionId = invocation.sessionId;
              _ref13 = this.parent.realms[this.realm].sessions;
