...
(function() {
  var Deferred, Promise, PromiseA, defer, fireHandlers, fs, fullfill, pad, readDir, reject, resolve, testFunc, thousand_sep,
  ...
  fullfill = function(promise, value) {
  ...
  fireHandlers = function(promise, what) {
    ...
    switch (promise._state) {
      case Promise.states.rejected:
        ...
        break;
      case Promise.states.fullfilled:
    ...
    handlers.forEach(function(handler, index) {
      ...
      if ((handler != null ? handler.constructor.name : void 0) === "Function") {
        return setImmediate(function() {
          ...
          try {
            result = handler(what);
            if (promise._state === Promises.states.fullfilled) {
  ...
  Promise = (function() {
    ...
    function Promise(_options) {
      ...
      this.isFullfilled = __bind(this.isFullfilled, this);
    ...
    Promise.prototype.then = function(onFullfilled, onRejected) {
      var retPromise;
      this._fullfillHandlers.push(onFullfilled || null);
      ...
      if (this.isPending()) {
        ...
        if (this.isFullfilled()) {
          if ((onFullfilled != null ? onFullfilled.constructor.name : void 0) === "Function") {
            resolve(retPromise, onFullfilled(this._value));
          } else {
    ...
    Promise.prototype.done = function(onFullfilled) {
      return this.then(onFullfilled, null);
    };
    ...
    Promise.prototype.isFullfilled = function() {
      if (this._state === Promise.states.fullfilled) {
        return true;
      } else {
        return false;
      }
  ...
  Deferred = (function() {
    ...
    Deferred.prototype.resolve = function(value) {
      ...
      return resolve(this._promise, value);
    };
    ...
    Deferred.prototype.reject = function(reason) {
      ...
      return reject(this._promise, reason);
    };
