...
(function() {
  ...
  Router = function(options) {
    var default_options, dispatch, fs, mime_types, path_tools, querystring, spawn, urlparse, _bodyparser, _dirlist_template, _extend, _make_request_wrapper, _parsePattern, _pushRoute;
    if (options == null) {
      options = {};
    }
