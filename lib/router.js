...
(function() {
  ...
  Router = function(options) {
    var default_options, dispatch, domain, escaped_icon, fs, http, mime_types, net, nsr_sessions, path_tools, querystring, spawn, urlparse, uuid, _bodyparser, _extend, _getSessionHandler, _isEmpty, _make_request_wrapper, _multipartparser, _parsePattern, _pushRoute;
    if (options == null) {
      options = {};
    }
    ...
    dispatch.directory = function(fpath, path, res) {
      ...
      while (resp.indexOf("<%= @cwd %>") !== -1) {
        resp = resp.replace("<%= @cwd %>", path === "." ? "/" : path);
      }
