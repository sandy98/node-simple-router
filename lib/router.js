...
(function() {
  ...
  Router = function(options) {
    ...
    dispatch = function(req, res) {
      var args, done, index, m, method, param, parsed, pathname, route, _i, _j, _len, _len1, _ref, _ref1;
      done = false;
    ...
    dispatch["static"] = function(pathname, res) {
      ...
      if (!!dispatch.logging) {
        dispatch.log("trying static " + full_path);
      }
        ...
        if (err) {
          ...
          links = ((function() {
            ...
            for (_i = 0, _len = files.length; _i < _len; _i++) {
              file = files[_i];
              _results.push("<li><a href='" + path + "/" + file + "'>" + file + "</a></li>");
            }
            return _results;
          })()).join('');
