...
(function() {
  ...
  Router = function(options) {
    ...
    dispatch.gallery = function(fpath, path, res) {
      var context;
      context = {
      ...
      context.cwd = path === "." ? "/" : path;
      return dispatch.dir_list(fpath, path).then(function(arrs) {
        var file, files, stats;
        ...
        context.files = (function() {
          ...
          for (_i = 0, _len = files.length; _i < _len; _i++) {
            file = files[_i];
            if ((_ref = mime_types[path_tools.extname(file)]) != null ? _ref.match(/image/) : void 0) {
              _results.push({
